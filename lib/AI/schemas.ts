...
export const CvEntrySchema = z.object({
  ...
  durationMonths: z.number().optional().describe("Computed duration in months, filled in programmatically after extraction — not something the model needs to calculate."),
});
