    ...
    <div className="relative flex min-h-screen min-h-dvh items-center justify-center bg-[#0d0b14] px-4 py-16">
      ...
      <div className="relative w-full max-w-[440px] rounded-3xl border border-white/10 bg-white/[0.04] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.4)] backdrop-blur-xl sm:p-10">
          ...
          <div className="flex items-center justify-between">
            <label className="flex cursor-pointer items-center gap-2 text-sm text-white/60 select-none">
              <input
                ...
                className="h-4 w-4 cursor-pointer rounded border border-white/20 bg-white/[0.06] accent-violet-500"
              />
              Remember me
            </label>
            <Link
        ...
        <p className="mt-5 text-center text-sm text-white/50">
          ...
          <Link href="/Register" className="text-violet-400 transition hover:text-violet-300">
            Sign Up
          </Link>
        </p>
